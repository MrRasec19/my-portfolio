<template>
  <slot>
    <svg viewBox="0 0 16 16" width="45" xmlns="http://www.w3.org/2000/svg" fill="none" class="icon hover:scale-105 transition-all">
    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
        <path
            fill="#0A66C2"
            d="M13.11 2H2.885A.88.88 0 002 2.866v10.268a.88.88 0 00.885.866h10.226a.882.882 0 00.889-.866V2.865a.88.88 0 00-.889-.864z"
        ></path>
